            ...
            <div className="bg-muted dark:bg-background py-24 md:py-32">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-12 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">Built to fit seamlessly into modern workflows.</h2>
                        <p className="text-muted-foreground">Our platform brings together intelligent code analysis and developer tools in one place.</p>
                    </div>
                </div>
            </div>
        </section>
